...
const UploadKrankenversicherung = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const filePath = `${session.user.id}/krankenversicherung/${fileName}`;
      ...
      toast({
        title: "Erfolg",
        description: "Krankenversicherung erfolgreich extrahiert!",
      });

      navigate(`/krankenversicherung-result?id=${data.data.id}`);
    } catch (error: any) {
      toast({
        title: "Fehler",
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Versicherungsnachweis oder Mitgliedsbescheinigung
              </p>
            </div>
...
export default UploadKrankenversicherung;