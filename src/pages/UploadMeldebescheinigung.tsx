...
const UploadMeldebescheinigung = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const filePath = `${session.user.id}/meldebescheinigung/${fileName}`;
      ...
      toast({
        title: "Erfolg",
        description: "Meldebescheinigung erfolgreich extrahiert!",
      });

      navigate(`/meldebescheinigung-result?id=${data.data.id}`);
    } catch (error: any) {
      toast({
        title: "Fehler",
...
export default UploadMeldebescheinigung;