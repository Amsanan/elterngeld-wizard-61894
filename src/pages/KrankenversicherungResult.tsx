...
const KrankenversicherungResult = () => {
    ...
    <div className="min-h-screen bg-background">
      <header className="border-b bg-card">
        <div className="container mx-auto px-4 py-6">
          ...
          <h1 className="text-2xl font-bold text-foreground">
            Extrahierte Daten: Krankenversicherung
          </h1>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-12">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-medium text-foreground">{data.versicherungsart || "Nicht verfügbar"}</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">Versicherungsbeginn</p>
                  <p className="font-medium text-foreground">{formatDate(data.versicherungsbeginn)}</p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground">Beitragssatz</p>
                  <p className="font-medium text-foreground">
                    {data.beitragssatz ? `${data.beitragssatz}%` : "Nicht verfügbar"}
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto mt-6 flex gap-4">
          <Button
            variant="outline"
            onClick={() => navigate("/krankenversicherung-list")}
            className="flex-1"
          >
...
export default KrankenversicherungResult;