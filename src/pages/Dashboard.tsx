    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Elterngeld-Rechner Card */}
          <Card className="p-6 bg-gradient-to-br from-green-500/10 to-emerald-500/10 mb-8 hover:shadow-lg transition-shadow">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-full bg-green-500/20 flex items-center justify-center">
                <span className="text-2xl">🧮</span>
              </div>
              <div className="flex-1">
                <h3 className="text-xl font-bold">Elterngeld-Rechner</h3>
                <p className="text-sm text-muted-foreground">
                  Berechnen Sie Ihr voraussichtliches Elterngeld
                </p>
              </div>
              <Button 
                onClick={() => navigate('/elterngeld-rechner')}
                variant="outline"
              >
                Berechnen
              </Button>
