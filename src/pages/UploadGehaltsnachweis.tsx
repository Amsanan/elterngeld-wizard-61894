...
const UploadGehaltsnachweis = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const filePath = `${session.user.id}/gehaltsnachweis/${fileName}`;
      ...
      toast({
        title: "Erfolg",
        description: "Gehaltsnachweis erfolgreich extrahiert!",
      });

      navigate(`/gehaltsnachweis-result?id=${data.data.id}`);
    } catch (error: any) {
      toast({
        title: "Fehler",
...
export default UploadGehaltsnachweis;